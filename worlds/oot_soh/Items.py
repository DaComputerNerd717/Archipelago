...
item_data_table: dict[Items, SohItemData] = {
    ...
    # 35
    Items.PIECE_OF_HEART: SohItemData(140, IC.progression_skip_balancing, 0, item_groups=["Hearts"]),
    # 8
    ...
    # 1
    Items.PIECE_OF_HEART_WINNER: SohItemData(161, IC.progression_skip_balancing, 0, item_groups=["Hearts"]),
