...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.DMC_UPPER_NEARBY, world, [
        (Regions.DMC_UPPER_LOCAL, lambda bundle: fire_timer_above(bundle, 48)),
        (Regions.DEATH_MOUNTAIN_SUMMIT, lambda bundle: True_()),
        (Regions.DMC_UPPER_GROTTO, lambda bundle: blast_or_smash(
            bundle) & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
    ])
    ...
    add_events(Regions.DMC_UPPER_LOCAL, world, [
        (EventLocations.DMC_GOSSIP_STONE_SONG_FAIRY, Events.CAN_ACCESS_FAIRIES, lambda bundle: has_explosives(
            bundle) & call_gossip_fairy_except_suns(bundle) & (fire_timer_above(bundle, 16) | hearts_above(bundle, 3)))
    ])
    # Locations
    add_locations(Regions.DMC_UPPER_LOCAL, world, [
        (Locations.DMC_WALL_FREESTANDING_POH, lambda bundle: fire_timer_above(bundle, 16) | hearts_above(bundle, 3)),
        (Locations.DMC_GS_CRATE, lambda bundle: (fire_timer_above(bundle, 8) | hearts_above(bundle, 3)) & is_child(bundle) & can_attack(bundle) & can_break_crates(bundle)),
        (Locations.DMC_GOSSIP_STONE_FAIRY, lambda bundle: call_gossip_fairy_except_suns(
            bundle) & has_explosives(bundle) & (fire_timer_above(bundle, 16) | hearts_above(bundle, 3))),
        (Locations.DMC_GOSSIP_STONE_BIG_FAIRY, lambda bundle: can_use(
            Items.SONG_OF_STORMS, bundle) & (fire_timer_above(bundle, 16) | hearts_above(bundle, 3))),
        (Locations.DMC_CRATE, lambda bundle: (fire_timer_above(bundle, 8) | hearts_above(bundle, 3)) & is_child(bundle) & can_break_crates(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.DMC_LADDER_REGION_NEARBY, world, [
        (Locations.DMC_DEKU_SCRUB, lambda bundle: is_child(
            bundle) & can_stun_deku(bundle))
    ])
    # Connections
    connect_regions(Regions.DMC_LADDER_REGION_NEARBY, world, [
        (Regions.DMC_UPPER_NEARBY, lambda bundle: hearts_above(bundle, 3)),
        (Regions.DMC_LOWER_NEARBY, lambda bundle: hearts_above(bundle, 3) & (can_use(Items.HOVER_BOOTS, bundle) | (can_do_trick(Tricks.DMC_BOULDER_JS,
    ...
    connect_regions(Regions.DMC_LOWER_NEARBY, world, [
        (Regions.DMC_LOWER_LOCAL, lambda bundle: fire_timer_above(bundle, 48)),
    ...
    connect_regions(Regions.DMC_LOWER_LOCAL, world, [
        ...
        (Regions.DMC_LADDER_REGION_NEARBY, lambda bundle: fire_timer_above(bundle, 8) | hearts_above(bundle, 3)),
        (Regions.DMC_CENTRAL_NEARBY, lambda bundle: (can_use(Items.HOVER_BOOTS, bundle) | can_use(
            Items.HOOKSHOT, bundle)) & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
        (Regions.DMC_CENTRAL_LOCAL, lambda bundle: (can_use(Items.HOVER_BOOTS, bundle) | can_use(Items.HOOKSHOT, bundle) | (
            is_adult(bundle) & can_shield(bundle) & can_do_trick(Tricks.DMC_BOLERO_JUMP, bundle))) & fire_timer_above(bundle, 24))
    ])
    ...
    add_locations(Regions.DMC_CENTRAL_NEARBY, world, [
        (Locations.SHEIK_IN_CRATER, lambda bundle: is_adult(bundle)
         & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
        (Locations.DMC_VOLCANO_FREESTANDING_POH, lambda bundle: is_adult(bundle) &
         hearts_above(bundle, 3) &
    ...
    connect_regions(Regions.DMC_CENTRAL_NEARBY, world, [
        (Regions.DMC_CENTRAL_LOCAL, lambda bundle: fire_timer_above(bundle, 48)),
    ])
    ...
    add_events(Regions.DMC_CENTRAL_LOCAL, world, [
        (EventLocations.DMC_BEAN_PLANT_FAIRY, Events.CAN_ACCESS_FAIRIES, lambda bundle: can_use(Items.MAGIC_BEAN,
         bundle) & can_use(Items.SONG_OF_STORMS, bundle) & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
        (EventLocations.DMC_BEAN_PATCH, LocalEvents.DMC_BEAN_PLANTED, lambda bundle: is_child(bundle)
         & can_use(Items.MAGIC_BEAN, bundle) & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
    ])
    # Locations
    add_locations(Regions.DMC_CENTRAL_LOCAL, world, [
        (Locations.DMC_GS_BEAN_PATCH, lambda bundle: (fire_timer_above(bundle, 8) | hearts_above(bundle, 3)) & can_spawn_soil_skull(bundle) & can_attack(bundle)),
        ...
        (Locations.DMC_BEAN_SPROUT_FAIRY1, lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN, bundle)
         & can_use(Items.SONG_OF_STORMS, bundle) & (fire_timer_above(bundle, 8) | hearts_above(bundle, 3))),
    ...
    connect_regions(Regions.DMC_DISTANT_PLATFORM, world, [
        (Regions.DMC_CENTRAL_LOCAL, lambda bundle: fire_timer_above(bundle, 48) & can_use(Items.DISTANT_SCARECROW, bundle))
    ])
