...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.KAK_BAZAAR, world, [
        (Locations.KAK_BAZAAR_ITEM1, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM2, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM3, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM4, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM5, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM6, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM7, lambda bundle: True_()),
        (Locations.KAK_BAZAAR_ITEM8, lambda bundle: True_()),
    ])
    ...
    add_locations(Regions.KAK_GRANNYS_POTION_SHOP, world, [
        ...
        (Locations.KAK_GRANNYS_SHOP,
         lambda bundle: is_adult(bundle) & can_use(Items.ADULT_WALLET, bundle) & (can_use(Items.ODD_MUSHROOM, bundle)) & trade_quest_step(
