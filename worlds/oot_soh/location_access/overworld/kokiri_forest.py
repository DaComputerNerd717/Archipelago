...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.KOKIRI_FOREST, world, [
        ...
        (Regions.LW_BRIDGE_FROM_FOREST, lambda bundle: OptionFilter(ClosedForest, 1, operator="ge") | is_adult(bundle) |
    ...
    add_locations(Regions.KF_KOKIRI_SHOP, world, [
        (Locations.KF_SHOP_ITEM1, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM2, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM3, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM4, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM5, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM6, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM7, lambda bundle: True_()),
        (Locations.KF_SHOP_ITEM8, lambda bundle: True_())
    ])
    # Connections
