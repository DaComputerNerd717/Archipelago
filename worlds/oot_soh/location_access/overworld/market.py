...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.MARKET_BAZAAR, world, [
        (Locations.MARKET_BAZAAR_ITEM1, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM2, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM3, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM4, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM5, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM6, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM7, lambda bundle: True_()),
        (Locations.MARKET_BAZAAR_ITEM8, lambda bundle: True_()),
    ])
    # Connections
    ...
    add_locations(Regions.MARKET_POTION_SHOP, world, [
        (Locations.MARKET_POTION_SHOP_ITEM1, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM2, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM3, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM4, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM5, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM6, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM7, lambda bundle: True_()),
        (Locations.MARKET_POTION_SHOP_ITEM8, lambda bundle: True_()),
    ])
    # Connections
    ...
    add_locations(Regions.MARKET_BOMBCHU_SHOP, world, [
        (Locations.MARKET_BOMBCHU_SHOP_ITEM1, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM2, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM3, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM4, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM5, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM6, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM7, lambda bundle: True_()),
        (Locations.MARKET_BOMBCHU_SHOP_ITEM8, lambda bundle: True_()),
    ])
    # Connections
