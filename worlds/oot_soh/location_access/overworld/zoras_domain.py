...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.ZD_SHOP, world, [
        (Locations.ZD_SHOP_ITEM1, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM2, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM3, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM4, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM5, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM6, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM7, lambda bundle: True_()),
        (Locations.ZD_SHOP_ITEM8, lambda bundle: True_()),
    ])
    # Connections
