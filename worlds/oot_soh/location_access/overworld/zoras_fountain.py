...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.ZORAS_FOUNTAIN, world, [
        ...
        (Regions.JABU_JABUS_BELLY_ENTRYWAY,
         lambda bundle: is_child(bundle) & (can_use(Items.BOTTLE_WITH_FISH, bundle) | OptionFilter(JabuJabu, 1))),
    ...
    add_locations(Regions.ZF_LAKEBED, world, [
        (Locations.ZF_BOTTOM_FREESTANDING_POH,
         lambda bundle: is_adult(bundle) & can_use(Items.IRON_BOOTS, bundle) & water_timer_above(bundle, 16)),
